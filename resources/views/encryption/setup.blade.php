                ...
                <div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-8" x-transition:enter-end="opacity-100 transform translate-x-0">
                    <div class="bg-white rounded-3xl shadow-xl border border-forest-100 overflow-hidden">
                        ...
                        <div class="p-6 md:p-8">
                            ...
                            <!-- Passphrase Tips -->
                            <div class="bg-forest-50 rounded-2xl p-5 mb-6 border border-forest-100">
                                <div class="flex gap-4">
                                    <div class="w-10 h-10 bg-cashdash-forest/20 rounded-xl flex items-center justify-center flex-shrink-0">
                                        <svg class="w-5 h-5 text-cashdash-forest" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                        </svg>
                                    </div>
                                    <div>
                                        <h3 class="font-semibold text-cashdash-text mb-2">Tips: Välj en lösenfras du kommer ihåg</h3>
                                        <p class="text-sm text-cashdash-muted leading-relaxed mb-3">
                                            Använd en <strong class="text-cashdash-text">mening som är lätt att komma ihåg</strong> men svår för andra att gissa.
                                        </p>
                                        <div class="space-y-2 text-sm">
                                            <div class="flex items-start gap-2">
                                                <span class="text-cashdash-success font-bold">✓</span>
                                                <span class="text-cashdash-muted"><strong class="text-cashdash-text">Mening:</strong> "MinHund2Springer&LekeriParken!"</span>
                                            </div>
                                            <div class="flex items-start gap-2">
                                                <span class="text-cashdash-success font-bold">✓</span>
                                                <span class="text-cashdash-muted"><strong class="text-cashdash-text">Lösenordshanterare:</strong> 1Password, Bitwarden eller liknande</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
